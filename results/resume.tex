...
Motivated sustainability professional with demonstrated expertise in policy-making, compliance, and project management seeking an Associate position in the Equity Action team at a global organization. Dedicated to driving positive impact and fostering equity within member value chains, I aim to leverage my skills in strategic planning, communication, and data analysis to support the mission of accelerating the transition to a sustainable world.
...
\small{\item{
\vspace{1mm}
\textbf{Analytical Skills}{: Critical Thinking, Attention to Detail, Strategic Planning, Communication Skills, Prioritization} \\ \vspace{1mm} 
\textbf{Technical Skills}{: PowerBI, MS Excel, QGIS, Greenly, SimaPro, Salesforce, ERP, Microsoft Teams} \\ \vspace{1mm}
}}
\end{itemize}
\begin{center}
\end{center}
